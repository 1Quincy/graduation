...
void TalkWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sendMsg((*reinterpret_cast< std::add_pointer_t<QJsonObject&>>(_a[1]))); break;
        case 1: _t->on_sendButton_clicked(); break;
        case 2: _t->sendMsgToServer((*reinterpret_cast< std::add_pointer_t<QJsonObject&>>(_a[1]))); break;
        case 3: _t->readMsgFromServer(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (TalkWindow::*)(QJsonObject & );
            if (_t _q_method = &TalkWindow::sendMsg; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TalkWindow::sendMsg(QJsonObject & _t1)
{
