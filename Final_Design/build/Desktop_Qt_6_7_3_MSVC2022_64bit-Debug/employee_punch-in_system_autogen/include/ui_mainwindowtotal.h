...
public:
    ...
    void setupUi(QMainWindow *MainWindowTotal)
    {
        ...
        MainWindowTotal->resize(900, 650);
...
"    border: 1px solid #dddddd;\n"
"}"));
        MainWindowTotal->setToolButtonStyle(Qt::ToolButtonStyle::ToolButtonTextUnderIcon);
        ...
        actionSignIn->setMenuRole(QAction::MenuRole::NoRole);
        ...
        actionLeave->setMenuRole(QAction::MenuRole::NoRole);
        ...
        actionPermit->setMenuRole(QAction::MenuRole::NoRole);
        actionExport = new QAction(MainWindowTotal);
        actionExport->setObjectName("actionExport");
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/icon/\345\257\274\345\207\272.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionExport->setIcon(icon3);
        actionExport->setMenuRole(QAction::MenuRole::NoRole);
        ...
        actionEmployeeInfo->setMenuRole(QAction::MenuRole::NoRole);
        ...
        actionSign_out->setMenuRole(QAction::MenuRole::NoRole);
        ...
        actionWorkTime->setMenuRole(QAction::MenuRole::NoRole);
        ...
        actionPerson->setMenuRole(QAction::MenuRole::NoRole);
...
#endif // QT_CONFIG(shortcut)
        actionExport->setText(QCoreApplication::translate("MainWindowTotal", "\345\257\274\345\207\272", nullptr));
#if QT_CONFIG(tooltip)
        actionExport->setToolTip(QCoreApplication::translate("MainWindowTotal", "\345\257\274\345\207\272", nullptr));
#endif // QT_CONFIG(tooltip)
