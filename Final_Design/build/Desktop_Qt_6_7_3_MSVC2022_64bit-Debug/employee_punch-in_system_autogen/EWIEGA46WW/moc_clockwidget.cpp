...
struct qt_meta_stringdata_CLASSClockWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSClockWidgetENDCLASS = QtMocHelpers::stringData(
    "ClockWidget",
    "updateTime",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSClockWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ClockWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSClockWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSClockWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSClockWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *ClockWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSClockWidgetENDCLASS.stringdata0))
