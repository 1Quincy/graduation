...
public:
    ...
    void setupUi(QDialog *DialogLogin)
    {
        ...
        BtnRegister->setGeometry(QRect(680, 331, 50, 20));
        QFont font;
...
"background-position: center;"));
        labelBackGround->setFrameShape(QFrame::Shape::Panel);
...
"}"));
        ...
        Remember = new QCheckBox(DialogLogin);
        Remember->setObjectName("Remember");
        Remember->setGeometry(QRect(470, 333, 71, 16));
        BtnModifyPwd = new QPushButton(DialogLogin);
        BtnModifyPwd->setObjectName("BtnModifyPwd");
        BtnModifyPwd->setGeometry(QRect(570, 331, 50, 20));
        BtnModifyPwd->setFont(font);
        BtnModifyPwd->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"    background-color: #4CAF50;\n"
"    color: white;\n"
"    border-radius: 5px;\n"
"    padding: 5px;\n"
...
"}"));
    ...
    void retranslateUi(QDialog *DialogLogin)
    {
        ...
        Remember->setText(QCoreApplication::translate("DialogLogin", "\350\256\260\344\275\217\345\257\206\347\240\201", nullptr));
        BtnModifyPwd->setText(QCoreApplication::translate("DialogLogin", "\344\277\256\346\224\271\345\257\206\347\240\201", nullptr));
    } // retranslateUi
